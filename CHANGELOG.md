...
- **A SQL string is anonymized name by name**, where the IDE injects SQL into it — a JDBC call, a
  ...
  IntelliJ IDEA Community among them. Nothing tells you which of the two happened.
