...
/**
 * **What "persistent state" means, in one place**, for the two rules that are statements about it:
 * nothing shipped persists a reduction, and nothing shipped roams what it does persist.
 *
 * Shared for the same reason [SHIPPED_CLASSES] is shared rather than re-imported per test — a second
 * definition of *what the platform can write to disk* would drift from this one on the day either is
 * updated, and both rules would still pass while meaning different things.
 */
